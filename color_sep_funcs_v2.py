...
def separate_colors(image_path, n_colors=None, output_dir=None, precision=0):
    ...
    # If output directory is not specified, create a temporary directory
    ...
    for idx, color in enumerate(unique_colors):
        ...
        color_name = "_".join(map(str, color.astype(int)))  # Name the image by the color value
        new_image.save(os.path.join(output_dir, f"color_{color_name}.png"))
        print(f"Saved: color_{color_name}.png")
